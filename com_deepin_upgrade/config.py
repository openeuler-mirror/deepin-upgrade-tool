...
# log文件
LOG_FILE = "/var/log/deepin_upgrade.log"
# 存储dnf数据信息目录
REPO_DATA_PATH = "/var/lib/pkgs_upgrade_info"
# cui使用的数据文件
...
# logo路径
LOGO = "{datapath}/img/{pngname}".format(datapath=PKG_PATH, pngname="window_notify.png")
